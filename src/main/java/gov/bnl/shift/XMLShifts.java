...
public class XMLShifts {
    private Collection<XMLShift> shifts = new LinkedList<XMLShift>();
     ...
     */
    public XMLShifts(final XMLShift s) {
        shifts.add(s);
    }
     ...
     */
    public void setShifts(final Collection<XMLShift> items) {
        this.shifts = items;
    }
     ...
     */
    public void addXMLShift(final XMLShift item) {
     ...
     */
    public static String toLog(final XMLShifts data) {
