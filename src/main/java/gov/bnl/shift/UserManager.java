...
public abstract class UserManager {
    ...
    private static final String defaultUserManager = "gov.bnl.shift.IDUserManager";
    ...
    static {
        ...
        try {
            newManager = (String) new InitialContext().lookup("shift/userManager");
            log.log(Level.CONFIG, "Found shift/userManager: {0}", newManager);
        } catch (Exception ex) {
            log.log(Level.CONFIG, "Using default shift/userManager: {0}", newManager);
        }
